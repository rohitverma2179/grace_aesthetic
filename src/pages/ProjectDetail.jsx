    ...
    <main className="bg-luxury-light">
      ...
      <div ref={triggerRef}>
        <div className="h-screen overflow-hidden flex flex-col justify-center">
          ...
          <div
            ref={horizontalRef}
            className="flex gap-4 md:gap-8 px-[5vw] md:px-[10vw] relative w-max"
          >
            {[
              ...
              <div
                key={i}
                className="w-[85vw] md:w-[45vw] lg:w-[40vw] h-[50vh] md:h-[60vh] shrink-0 relative group rounded-4xl overflow-hidden shadow-2xl"
              >
                <img
                  src={img}
      ...
      <Section variant="form" padding="lg">
        <Container className="max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-[clamp(2rem,5vw,3rem)] font-serif text-luxury-dark uppercase tracking-tight mb-4">
              Contact
            </h2>
            <p className="text-xs uppercase tracking-[0.2em] text-luxury-dark/60 font-bold max-w-2xl mx-auto">
              WE INVITE YOU TO EXPERIENCE THE UNIQUE LIFESTYLE OF GRACE
              AESTHETIC FIRST-HAND. PLEASE FILL IN THE FORM BELOW AND WE WILL BE
              IN TOUCH.
            </p>
          </div>
          ...
          <form className="space-y-10">
            <div className="border-b border-luxury-dark/20 pb-4">
              <label className="block text-[10px] uppercase font-bold tracking-widest text-luxury-dark/40 mb-2">
                FULL NAME
              </label>
              <input
                type="text"
                className="w-full bg-transparent outline-none py-2 text-lg font-serif italic"
            ...
            <div className="border-b border-luxury-dark/20 pb-4">
              ...
              <textarea
                className="w-full bg-transparent outline-none py-2 text-lg font-serif italic resize-none h-32"
